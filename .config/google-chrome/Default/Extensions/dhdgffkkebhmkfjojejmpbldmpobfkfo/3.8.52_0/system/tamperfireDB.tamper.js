...
// @require    http://userscripts.org/scripts/source/179031.user.js
...
(function() {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        env(html, function (errors, window) {
            ...
            with (window) {
                main.apply(window, [ window, $, $, malert ]);
            }
        });

        return { done: function(f) { main = f; } };
    } else {
        return { done: function(f) { f(window, $, $, alert); } };
    }
})()
.done(function(window, $, jQuery, alert) {
    var V = false;
    var D = true;
    var MIN = 1;
    var MAX = 60;
    ...
    if (!NODEJS && setupParameters()) return;
